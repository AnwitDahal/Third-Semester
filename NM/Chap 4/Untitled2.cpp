...
int main() {
    int rows, cols;
    printf("Enter the number of rows and columns of the matrix (must be square): ");
    scanf("%d", &rows);
    cols = rows;
    ...
    printf("Enter the elements of the vector b (right-hand side of equations):\n");
    for (int i = 0; i < rows; i++) {
